...
<!Doctype HTML>
    ...
    <body>
        ...
        <form method="POST">
            ...
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" placeholder="Endereco" aria-label="Endereco" type="text"
                        name="endereco" id="endereco">
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Telefone" aria-label="Telefone" type="text"
